...
**This is an experimental, I would migrate [ENet](https://github.com/TimoSaemann/caffe-enet) from Linux to Windows, and based on @willyd work. It is a work-in-progress.**
...
If you want to read the Chines version of READMER, please click on it please click [README-Chinese](https://github.com/runhang/caffe-enet-windows/blob/master/README-Chinese.md)
